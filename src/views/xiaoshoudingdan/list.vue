	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					...
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.shuliangstart" placeholder="最小数量"
								clearable>
							</el-input>至
							<el-input class="search_inp" v-model="searchQuery.shuliangend" placeholder="最大数量"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<br>
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('xiaoshoudingdan','新增')">
						新增
					</el-button>
					<el-button class="view_btn"  v-if=" btnAuth('xiaoshoudingdan','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">
						详情
					</el-button>
					<el-button class="edit_btn" type="primary" :disabled="selRows.length==1?false:true" @click="editClick()" v-if=" btnAuth('xiaoshoudingdan','修改')">
						修改
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('xiaoshoudingdan','删除')">
						删除
					</el-button>
					<el-button class="statis_btn" type="warning" @click="echartClick1" v-if="btnAuth('xiaoshoudingdan','销售量统计')">
						销售量统计
					</el-button>
				</div>
			</div>
			...
			<el-table
				...
				ref="table"
				v-if="btnAuth('xiaoshoudingdan','查看')"
				:data="list"
				...
				<el-table-column
					 ...
					 align="left" 
					 header-align="left"
					 prop="xiaoshoudingdan"
					label="销售订单">
					<template #default="scope">
						{{scope.row.xiaoshoudingdan}}
					</template>
				</el-table-column>
				<el-table-column
					 :resizable='true' 
				...
				<el-table-column
					 ...
					 align="left" 
					 header-align="left"
					 prop="xiaoshouzhanghao"
					label="销售账号">
					<template #default="scope">
						{{scope.row.xiaoshouzhanghao}}
					</template>
				</el-table-column>
				<el-table-column
					 :resizable='true' 
					 ...
					 align="left" 
					 header-align="left"
					 prop="xiaoshouxingming"
					label="销售姓名">
					<template #default="scope">
						{{scope.row.xiaoshouxingming}}
					</template>
				</el-table-column>
				...
				<el-table-column label="审核" v-if="btnAuth('xiaoshoudingdan','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('xiaoshoudingdan','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('xiaoshoudingdan','修改')">
							修改
						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('xiaoshoudingdan','删除')">
							删除
						</el-button>
					</template>
				</el-table-column>
		...
		<!-- 统计图弹窗 -->
		<el-dialog v-model="echartVisible" :title="'销售量统计'" width="70%">
