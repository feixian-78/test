	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.xiaoshouzhanghao" placeholder="销售账号"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<br>
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('xiaoshourenyuan','新增')">
						新增
					</el-button>
					<el-button class="view_btn"  v-if=" btnAuth('xiaoshourenyuan','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">
						详情
					</el-button>
					<el-button class="edit_btn" type="primary" :disabled="selRows.length==1?false:true" @click="editClick()" v-if=" btnAuth('xiaoshourenyuan','修改')">
						修改
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('xiaoshourenyuan','删除')">
						删除
					</el-button>
				</div>
			</div>
			...
			<el-table
				...
				ref="table"
				v-if="btnAuth('xiaoshourenyuan','查看')"
				:data="list"
				...
				<el-table-column label="审核" v-if="btnAuth('xiaoshourenyuan','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('xiaoshourenyuan','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('xiaoshourenyuan','修改')">
							修改
						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('xiaoshourenyuan','删除')">
							删除
						</el-button>
					</template>
				</el-table-column>
...
<script setup>
	...
	//基础信息
	const tableName = 'xiaoshourenyuan'
	const formName = '销售人员'
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.xiaoshouzhanghao&&searchQuery.value.xiaoshouzhanghao!=''){
			params['xiaoshouzhanghao'] = '%' + searchQuery.value.xiaoshouzhanghao + '%'
		}
