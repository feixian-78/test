	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<br>
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('caigourenyuan','新增')">
						新增
					</el-button>
					<el-button class="view_btn"  v-if=" btnAuth('caigourenyuan','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">
						详情
					</el-button>
					<el-button class="edit_btn" type="primary" :disabled="selRows.length==1?false:true" @click="editClick()" v-if=" btnAuth('caigourenyuan','修改')">
						修改
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('caigourenyuan','删除')">
						删除
					</el-button>
				</div>
			</div>
			...
			<el-table
				...
				<el-table-column label="审核" v-if="btnAuth('caigourenyuan','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('caigourenyuan','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('caigourenyuan','修改')">
							修改
						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('caigourenyuan','删除')">
							删除
						</el-button>
					</template>
				</el-table-column>
...
<script setup>
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.caigouzhanghao&&searchQuery.value.caigouzhanghao!=''){
			params['caigouzhanghao'] = '%' + searchQuery.value.caigouzhanghao + '%'
		}
