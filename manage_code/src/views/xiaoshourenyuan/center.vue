				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="销售账号" prop="xiaoshouzhanghao">
							<el-input class="list_inp" v-model="user.xiaoshouzhanghao" readonly placeholder="销售账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="销售姓名" prop="xiaoshouxingming">
							<el-input class="list_inp" v-model="user.xiaoshouxingming"  placeholder="销售姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="xiaoshourenyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const xiaoshourenyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.xiaoshouzhanghao)){
		...
		if((!user.value.xiaoshouxingming)){
