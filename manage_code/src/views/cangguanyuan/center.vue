				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="仓管员账号" prop="cangguanyuanzhanghao">
							<el-input class="list_inp" v-model="user.cangguanyuanzhanghao" readonly placeholder="仓管员账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="仓管员姓名" prop="cangguanyuanxingming">
							<el-input class="list_inp" v-model="user.cangguanyuanxingming"  placeholder="仓管员姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="cangguanyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const cangguanyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.cangguanyuanzhanghao)){
		...
		if((!user.value.cangguanyuanxingming)){
