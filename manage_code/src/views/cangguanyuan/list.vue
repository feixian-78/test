	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.cangguanyuanzhanghao" placeholder="仓管员账号"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<br>
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('cangguanyuan','新增')">
						新增
					</el-button>
					<el-button class="view_btn"  v-if=" btnAuth('cangguanyuan','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">
						详情
					</el-button>
					<el-button class="edit_btn" type="primary" :disabled="selRows.length==1?false:true" @click="editClick()" v-if=" btnAuth('cangguanyuan','修改')">
						修改
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('cangguanyuan','删除')">
						删除
					</el-button>
				</div>
			</div>
			...
			<el-table
				...
				<el-table-column
					 ...
					 align="left" 
					 header-align="left"
					 prop="cangguanyuanzhanghao"
					label="仓管员账号">
					<template #default="scope">
						{{scope.row.cangguanyuanzhanghao}}
					</template>
				</el-table-column>
				<el-table-column
					 :resizable='true' 
					 ...
					 align="left" 
					 header-align="left"
					 prop="cangguanyuanxingming"
					label="仓管员姓名">
					<template #default="scope">
						{{scope.row.cangguanyuanxingming}}
					</template>
				</el-table-column>
				...
				<el-table-column label="审核" v-if="btnAuth('cangguanyuan','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('cangguanyuan','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('cangguanyuan','修改')">
							修改
						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('cangguanyuan','删除')">
							删除
						</el-button>
					</template>
				</el-table-column>
...
<script setup>
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.cangguanyuanzhanghao&&searchQuery.value.cangguanyuanzhanghao!=''){
			params['cangguanyuanzhanghao'] = '%' + searchQuery.value.cangguanyuanzhanghao + '%'
		}
	...
	const approvalClick = (row) => {
		let params = {
			id:row.id,
			cangguanyuanzhanghao: row.cangguanyuanzhanghao,
			mima: row.mima,
			cangguanyuanxingming: row.cangguanyuanxingming,
